...
floor_contents[3] = []
floor_contents[0].append("elerium generator")
floor_contents[0].append("elerium microchip")
floor_contents[0].append("dilithium generator")
floor_contents[0].append("dilithium microchip")
